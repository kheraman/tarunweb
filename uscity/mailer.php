...
// validation
	...
	if(isset($_POST["captcha"])&&$_POST["captcha"]!=""&&$_SESSION["code"]==$_POST["captcha"])
    {
			...
			echo $insertdata = "insert into contactus (name,email,subject,phone,message) values ('".$Name."','".$Email."','".$Subject."','".$Tel."','".$Message."')";							
			die;				
			...
			if ($catresultname){
			  print "<meta http-equiv=\"refresh\" content=\"0;URL=contact.php?value=thanks\">";
			}
			else{
				//echo "333";die;
			  print "<meta http-equiv=\"refresh\" content=\"0;URL=error/index.html\">";
			}
	}	
	else
	{
