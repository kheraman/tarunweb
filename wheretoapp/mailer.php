...
// validation
	...
	if(isset($_POST["captcha"])&&$_POST["captcha"]!=""&&$_SESSION["code"]==$_POST["captcha"])
    {
			...
			$insertdata = "insert into contactus (name,email,subject,phone,message) values ('".$Name."','".$Email."','".$Subject."','".$Tel."','".$Message."')";							
	...
	{
		//echo "4444";die;
		print "<meta http-equiv=\"refresh\" content=\"0;URL=contact.php?value=oops\">";
