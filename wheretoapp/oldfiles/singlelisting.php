...
<style>
        ...
        .parallel-div {
            width: 48%; /* Set the width of each parallel div (adjust as needed) */
            box-sizing: border-box; /* Include padding and border in the total width */
...
function onsubmitform()
{
   ...
   if(document.getElementById('captcha').value=='')
    ...
    <section class="listing-banner">
		...
		<h1 style="color:#000;align:center;"><?php echo $response['location_info']['name'];?><span class="icon icon-verified"></span></h1>
            <div class="parallel-divs">
				<div class="parallel-div">
					<!-- Content for the first parallel div -->
							...
							<div class="widget-content">
                                <div class="map-box">
                                    <div class="map-canvas"
                                        ...
                                        data-content="<i class="flaticon-pin"></i><?php echo $response['location_info']['street'].", ";  ?><?php echo $response['location_info']['city'];?> - <?php echo $response['location_info']['postal_code'];?><br><a href='mailto:<?php echo $response['location_info']['owner_email'];?>'><?php echo $response['location_info']['owner_email'];?></a><br>Phone : <?php echo $response['location_info']['phone'];?>">
                                    </div>
                                </div>
				...
				<div class="parallel-div">
					<!-- Content for the second parallel div -->
					<!-- Content Box -->
            <div class="content-box">
				...
				<div class="location clearfix"><?php if($response['location_info']['hide_address'] == "") { ?><i class="flaticon-pin"></i><?php echo $response['location_info']['street'].", "; }  echo $response['location_info']['city'];?> - <?php echo $response['location_info']['postal_code'];  ?><br>Phone : <?php echo $response['location_info']['phone'];?><br>Website : <a style="color:blue;" href="<?php echo $response['location_info']['biz_url'];?>" target="_blank">Click here..</a><br>Sub-Category : <?php echo $response['location_info']['sub_category_name'];?></div>
			...
			<div class="listing-options">
                <ul class="options-list">    
					...
					<li><a href="$response['location_info']['facebook_url']"><span class="fab fa-facebook"></span></a></li>
					<?php } ?>
					<?php if($response['location_info']['twitter_url'] !="") { ?>
					<li><a href="$response['location_info']['twitter_url']"><span class="fab fa-twitter"></span></a></li>
					<?php } ?>
					<?php if($response['location_info']['googleplus_url'] !="") { ?>
					<li><a href="$response['location_info']['googleplus_url']"><span class="fab fa-google-plus"></span></a></li>
					<?php } ?>
					<?php if($response['location_info']['linkedin_url'] !="") { ?>
					<li><a href="$response['location_info']['linkedin_url']"><span class="fab fa-linkedin"></span></a></li>
					<?php } ?>
...
<!--Google Map APi Key-->
<script  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDmKVesiNSxzSzbb616K6E1dZZa67zRm3s"></script>
