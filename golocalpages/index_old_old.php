                        ...
                        <div class="category-overlay">
                            ...
                            <div class="category-content">
                                <h3 class="category-title">
                                    <a href="grid-fullwidth.php?cat_id=12">Pets</a>
                                </h3>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-1-bg">
                                <div class="category-overlay">
                                    ...
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="grid-fullwidth.php?cat_id=9">Home Services</a>
                                        </h3>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-2-bg">
                                <div class="category-overlay">
                                    ...
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="grid-fullwidth.php?cat_id=14">Real Estate</a>
                                        </h3>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-5-bg">
                                <div class="category-overlay">
                                    ...
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="grid-fullwidth.php?cat_id=23">Military Recruiting office</a>
                                        </h3>
                        ...
                        <div class="category">
                            <div class="category_bg_box cat-3-bg">
                                <div class="category-overlay">
                                    ...
                                    <div class="category-content">
                                        <h3 class="category-title">
                                            <a href="grid-fullwidth.php?cat_id=20">Public Services Government</a>
                                        </h3>
