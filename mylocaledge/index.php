        ...
        <div class="container-fluid">
            ...
            <div class="carousel-outer">
                <div class="four-items-carousel owl-carousel owl-theme default-nav">
					...
					<?php
				//echo "test";
				$sql = "select * from listing_master as a left join category_master as b on a.category_id = b.cat_id order by a.id desc LIMIT 96,10";							
					$result = mysqli_query($con,$sql);							
					...
					<div class="listing-block">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <h3><a href="Listing/L-<?php echo $row['yid'];?>"><?php echo $row['name'];?> <span class="icon icon-verified"></span></a></h3>
