...
<div class="sub-banner overview-bgi">
    <div class="container">
        <div class="breadcrumb-area" style="text-align:center;margin:20px;">
...
<div class="listing-block col-lg-3 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <ul class="info">
                                            <li><span class="flaticon-pin"></span> <?php echo $cat_data['city'];?>, <?php echo $cat_data['country_iso'];?>-<?php echo $cat_data['postal_code'];?></li>
